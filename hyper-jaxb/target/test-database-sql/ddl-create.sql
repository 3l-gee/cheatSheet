...
create table ejb_samples_root_header.DISTANCE_TYPE (VALUE_ numeric(20,10), HJID bigserial not null, UNIT varchar(255), primary key (HJID));
...
create table ejb_samples_root_header.ROOT (HEADER_ROOT_HJID bigint unique, HJID bigserial not null, JAXB_ITEM_ROOT_HJID bigint, NAME_ varchar(255), primary key (HJID));
...
alter table if exists ejb_samples_root_header.ROOT add constraint FKsc5lxyct4eckqqbmrv9weubnc foreign key (JAXB_ITEM_ROOT_HJID) references ejb_samples_root_header.DISTANCE_TYPE;
