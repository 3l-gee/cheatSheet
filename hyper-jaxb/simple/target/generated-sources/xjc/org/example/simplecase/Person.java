...
public class Person implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            boolean lhsFieldIsSet = this.isSetAge();
            boolean rhsFieldIsSet = that.isSetAge();
            String lhsField;
            lhsField = this.getAge();
            String rhsField;
            rhsField = that.getAge();
            ObjectLocator lhsFieldLocator = LocatorUtils.property(thisLocator, "age", lhsField);
            ObjectLocator rhsFieldLocator = LocatorUtils.property(thatLocator, "age", rhsField);
            if (!strategy.equals(lhsFieldLocator, rhsFieldLocator, lhsField, rhsField, lhsFieldIsSet, rhsFieldIsSet)) {
                return false;
            }
        }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            boolean theFieldIsSet = this.isSetAge();
            String theField;
            theField = this.getAge();
            ObjectLocator theFieldLocator = LocatorUtils.property(locator, "age", theField);
            currentHashCode = strategy.hashCode(theFieldLocator, currentHashCode, theField, theFieldIsSet);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ...
            String theField;
            theField = this.getAge();
            strategy.appendField(locator, this, "age", buffer, theField, theFieldIsSet);
        }
        {
            boolean theFieldIsSet = this.isSetTitle();
            String theField;
